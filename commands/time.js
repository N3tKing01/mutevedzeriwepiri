      ...
      try {
        ...
        if (!tzName) {
          try {
            ...
            const nomOpts = { headers: { "User-Agent": "❦฿яḙᾰʟ_✘∂❦ - Time Command" } };
