...
const CHANNEL_JIDS = process.env.CHANNEL_JIDS ? process.env.CHANNEL_JIDS.split(',') : [
    ...
    "120363420926702173@newsletter,
    "120363422330539962@newsletter",
    "120363386535738813@newsletter",
...
const OWNER_NAME = process.env.OWNER_NAME || "BREAL & MIDKBAN-TECH";

const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://files.catbox.moe/7svy43.jpeg";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY BE THE REAL - MD 💜";
const DEV = process.env.DEV || 'MIDKBAN-TECH__&__JOSHKING';
            ...
            case 'sunset':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: "฿яε@ʟ - ღ∂",
                        serverMessageId: 200
                    },
                        externalAdReply: {
                            title: "📃 ṧṳℵṧḙт Command Menu",
...
👋 Hey *${name}* 🤩  
🎉 Pairing Complete – You're good to go! no noise, just control. Operate in silence, dominate in shadows. 
